...
below 10 % (`Invalid params` on 1.31.37; 1.38.0 accepts down to 1 %). The plugin therefore puts the level of the brightest channel
...
protocol, smooth 10 Hz fades through the low end, and kelvin-mode whites.
